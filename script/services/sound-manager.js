...
static freqTable = {
	...
	hit() {
		const rate = 2.5
		const len = 0.3
		this.tone2('A2', 'A1', 0.4, rate, 'triangle', len)
		this.tone2('A#2', 'A#1', 0.1, rate, 'square', len)
		this.tone2('C2', 'C1', 0.4, rate, 'triangle', 2*len, 0.4*len)
		this.tone2('H1', 'H0', 0.1, rate, 'square', 2*len, 0.4*len)
